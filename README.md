# ReelSaverNative 1.3.0

Нативный Android/Cordova-модуль ReelSave отвечает только за:

- получение публичной страницы Reel;
- fallback через скрытый Android WebView;
- обнаружение URL MP4;
...
Реклама **намеренно вынесена из этого плагина**. ReelSave 1.3 использует ту же схему, что проект AliasTop BUILD 30:
